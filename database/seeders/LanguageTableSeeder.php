...
//        ];
        ...
        $englishLanguage = Language::create($spanishLanguageArray);
        if (file_exists(public_path('/images/language/español.png'))) {
            $imagePath = public_path('/images/language/español.png');
            $englishLanguage->clearMediaCollection('offer');
            $englishLanguage->addMedia($imagePath)->toMediaCollection('offer', 'public_custom');
//            $englishLanguage->addMedia(public_path('/images/language/español.png'))->preservingOriginal()->toMediaCollection('language');
        }
