    ...
    <div class="col-12">
        ...
        <div class="db-card">
            ...
            <div class="db-card-body" id="print">
                ...
                <p class="text-center">
                    <span class="block capitalize mt-4">{{ polize.policyNumber }}</span>
                    <span class="block">{{ polize.nit }}</span>
                </p>
...
export default {
    ...
    computed: {
        polizes: function () {
            return this.$store.getters['polizes/show'];
        },
        setting: function () {
    ...
    mounted() {
        ...
        this.$store.dispatch('polizes/show', this.$route.params.id).then(res => {
