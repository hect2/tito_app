...
use App\Http\Controllers\TransactionSalesController;
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'localization'])->group(function () {
    ...
    Route::prefix('transactionsSales')->name('transactionsSales.')->group(function () {
        ...
        Route::post('/reverse', [TransactionSalesController::class, 'reverse']);
    });
    ...
    Route::prefix('reservations')->name('reservations.')->group(function(){
        ...
        Route::match(['post', 'put', 'patch'], '/{reservation}', [ReservationsController::class, 'update']);
        Route::delete('/{reservation}', [ReservationsController::class, 'destroy']);
        Route::get('/export', [ReservationsController::class, 'export']);
    });
